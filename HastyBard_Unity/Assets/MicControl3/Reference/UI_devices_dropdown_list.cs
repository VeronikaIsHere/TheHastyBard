...
public class UI_devices_dropdown_list : MonoBehaviour
{
    ...
    [SerializeField] private MicControlC getController;
    ...
    void Update ()
    {
        ...
        if (transform.GetComponent<Dropdown> ().value != getController.InputDevice)
        {
            ...
            //dubbel check in your controller's inspector during runtime wether or not the new connection was a succes.
        }
